...
public class VendorAddController {
	...
	public String doPost(
			@RequestParam(required = false, defaultValue = "") String vendor_id,
			@RequestParam(required = false, defaultValue = "") String vendor_name,
			@RequestParam(required = false, defaultValue = "") String vendor_type,
			@RequestParam(required = false, defaultValue = "") String phone_no,
		...
		vendorDTO.setVendor_name(vendor_name.trim());
		vendorDTO.setVendor_type(vendor_type.trim());
		vendorDTO.setPhone_no(phone_no.trim());
		vendorDTO.setAddr(addr.trim());
